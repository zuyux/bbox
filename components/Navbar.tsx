        ...
        <div className="mx-auto px-2 md:px-4">
          <div className="grid grid-cols-3 h-12 items-center">
            ...
            <div className="flex justify-start">
              <Image src="/bbox.png" alt="Sumak Logo" width={21} height={21} className="object-contain"/>
              <Link href="/"><h1 className='title mx-3 my-3 opacity-55 hover:opacity-100'>BBOX</h1></Link>
            </div>
