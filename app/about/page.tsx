...
export default function AboutPage() {
  return (
    <div className="max-w-2xl mx-auto py-36 px-4">
      ...
      <p className="mb-4">
        <strong><LocalizedText>BBOXX</LocalizedText></strong> <LocalizedText>is a universal registry for verified open-source software. It helps people discover, compare, fund, and coordinate high-integrity apps across Bitcoin, other chains, privacy tooling, safe AI, and independent off-chain software.
      </LocalizedText></p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        <LocalizedText>BBOXX is developed and maintained by </LocalizedText><Link href="https://zuyux.org" className="hover:underline"><strong><LocalizedText>zuyux</LocalizedText></strong></Link><LocalizedText>, an IT R&amp;D Lab based in Peru, dedicated to building innovative solutions for the decentralized web.
      </LocalizedText></p>
      <p className="mb-4">
