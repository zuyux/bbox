...
export default function UsersPage() {
  ...
  if (loading) return <div className="text-center mt-10"><LocalizedText>Loading users...</LocalizedText></div>;
  if (error) return <div className="text-center mt-10 text-red-500">{error}</div>;

  return (
    <div className="max-w-2xl mx-auto py-10 mt-16">
      <h1 className="text-2xl font-bold mb-6"><LocalizedText>Registered Users</LocalizedText></h1>
