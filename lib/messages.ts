...
const en = {
  seo: {
    title: 'BBOXX — Open App Store for Verified Software',
  ...
  nav: { primary: 'Primary navigation', home: 'BBOXX home', search: 'Search apps', searchPlaceholder: 'SEARCH APPS...', openSearch: 'Open search' },
  ...
  home: {
    ...
    loading: 'Loading apps from the public app database...', what: 'What BBOXX does', whatTitle: 'Discovery, coordination, and funding in one place.',
    whatLead: 'BBOXX maps high-integrity open-source software with app profiles, reviews, grants, and milestone accountability anchored by the Bitcoin App Registry.',
    ecosystemPillars: [
      ...
      { label: 'Open-source commons', detail: 'A neutral surface where users, contributors and communities can coordinate around high-integrity software.' },
    ],
    ...
    faqBadge: 'Helpful answers', faqTitle: 'Frequently asked questions', faqLead: "Everything you need to know about BBOXX. Can't find your answer? Start with the docs or explore the app registry.",
    faqItems: [
      { question: 'Is BBOXX free to use?', answer: 'Yes. Browsing apps, reading profiles, and exploring public metadata are free. Funding and app-specific services may involve separate payment flows set by each project.' },
      { question: 'What kinds of apps are listed on BBOXX?', answer: 'BBOXX focuses on open-source Bitcoin apps, privacy tools, safe AI projects, wallets, infrastructure, developer tools, and other high-integrity software in the sovereign technology ecosystem.' },
      ...
      { question: 'How does funding work?', answer: 'BBOXX is designed to make funding context easier to understand through public project details, milestones, and delivery signals before support moves to a project.' },
      ...
      { question: 'Who is BBOXX for?', answer: 'BBOXX is for users looking for trustworthy software, builders publishing open-source projects, funders supporting public goods, and communities coordinating around useful tools.' },
    ...
    ctaEyebrow: 'Explore the sovereign software commons', ctaTitle: 'Find and support verified open-source software.', ctaLead: 'Use BBOXX to move from scattered links to readable app profiles: metadata, source code, milestones, reviews, and funding context together.'
  }
};

const es: typeof en = {
  seo: {
    title: 'BBOXX — Tienda abierta de software verificado',
  ...
  nav: { primary: 'Navegación principal', home: 'Inicio de BBOXX', search: 'Buscar aplicaciones', searchPlaceholder: 'BUSCAR APLICACIONES...', openSearch: 'Abrir búsqueda' },
  ...
  home: {
    ...
    what: 'Qué hace BBOXX', whatTitle: 'Descubrimiento, coordinación y financiamiento en un solo lugar.', whatLead: 'BBOXX organiza software de código abierto de alta integridad con perfiles, reseñas, subvenciones e hitos verificables anclados por el Bitcoin App Registry.',
    ecosystemPillars: [
      ...
      { label: 'Bienes comunes de código abierto', detail: 'Un espacio neutral donde usuarios, colaboradores y comunidades pueden coordinarse en torno a software de alta integridad.' },
    ],
    ...
    faqBadge: 'Respuestas útiles', faqTitle: 'Preguntas frecuentes', faqLead: 'Todo lo que necesitas saber sobre BBOXX. ¿No encuentras tu respuesta? Consulta la documentación o explora el registro.',
    faqItems: [
      { question: '¿BBOXX es gratis?', answer: 'Sí. Explorar aplicaciones, leer perfiles y consultar metadatos públicos es gratis. El financiamiento y los servicios específicos de cada aplicación pueden incluir pagos definidos por cada proyecto.' },
      { question: '¿Qué tipos de aplicaciones aparecen en BBOXX?', answer: 'BBOXX se centra en aplicaciones Bitcoin de código abierto, herramientas de privacidad, proyectos de IA segura, billeteras, infraestructura, herramientas para desarrolladores y otro software confiable del ecosistema de tecnología soberana.' },
      ...
      { question: '¿Cómo funciona el financiamiento?', answer: 'BBOXX facilita la comprensión del financiamiento mediante detalles públicos del proyecto, hitos y señales de entrega antes de que el apoyo llegue al proyecto.' },
      ...
      { question: '¿Para quién es BBOXX?', answer: 'BBOXX es para usuarios que buscan software confiable, creadores que publican proyectos de código abierto, financiadores de bienes públicos y comunidades que coordinan herramientas útiles.' },
...
const pt: typeof en = {
  seo: {
    title: 'BBOXX — Loja aberta de software verificado',
  ...
  nav: { primary: 'Navegação principal', home: 'Início da BBOXX', search: 'Buscar aplicativos', searchPlaceholder: 'BUSCAR APLICATIVOS...', openSearch: 'Abrir busca' },
  footer: { tagline: 'Nossa loja aberta de aplicativos' }, accessibility: { skip: 'Ir para o conteúdo principal', main: 'Conteúdo principal' },
  home: {
    badge: 'ESPAÇO PARA HUMANOS', title: 'BBOXX é a loja aberta de aplicativos para todos', lead: 'Descubra aplicativos úteis, compare informações confiáveis e apoie projetos abertamente, sem depender de intermediários ocultos.',
    ...
    what: 'O que a BBOXX faz', whatTitle: 'Descoberta, coordenação e financiamento em um só lugar.', whatLead: 'A BBOXX organiza software de código aberto de alta integridade com perfis, avaliações, subsídios e marcos verificáveis ancorados pelo Bitcoin App Registry.',
    ecosystemPillars: [
      ...
      { label: 'Bens comuns de código aberto', detail: 'Um espaço neutro onde usuários, colaboradores e comunidades podem se coordenar em torno de software de alta integridade.' },
    ],
    ...
    faqBadge: 'Respostas úteis', faqTitle: 'Perguntas frequentes', faqLead: 'Tudo o que você precisa saber sobre a BBOXX. Não encontrou sua resposta? Consulte a documentação ou explore o registro.',
    faqItems: [
      { question: 'A BBOXX é gratuita?', answer: 'Sim. Explorar aplicativos, ler perfis e consultar metadados públicos é gratuito. O financiamento e os serviços específicos de cada aplicativo podem envolver pagamentos definidos por cada projeto.' },
      { question: 'Que tipos de aplicativos aparecem na BBOXX?', answer: 'A BBOXX se concentra em aplicativos Bitcoin de código aberto, ferramentas de privacidade, projetos de IA segura, carteiras, infraestrutura, ferramentas para desenvolvedores e outros softwares confiáveis do ecossistema de tecnologia soberana.' },
      ...
      { question: 'Como funciona o financiamento?', answer: 'A BBOXX facilita a compreensão do financiamento por meio de detalhes públicos do projeto, marcos e sinais de entrega antes que o apoio seja destinado ao projeto.' },
      ...
      { question: 'Para quem é a BBOXX?', answer: 'A BBOXX é para usuários que procuram software confiável, criadores que publicam projetos de código aberto, financiadores de bens públicos e comunidades que coordenam ferramentas úteis.' },
