...
const es: typeof en = {
  ...
  home: {
    badge: 'ESPACIO PARA HUMANOS', title: 'BBOX es la tienda abierta de aplicaciones para todos', lead: 'Descubre aplicaciones útiles, compara información confiable y apoya proyectos abiertamente, sin depender de intermediarios ocultos.',
