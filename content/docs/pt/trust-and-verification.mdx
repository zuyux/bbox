...
description: Entenda o que os sinais do BBOX indicam, seus limites e como avaliar software com segurança.
---

BBOX reúne evidências para facilitar a avaliação. Ele não substitui julgamento por um selo, nota ou transação blockchain.
...
| Selo verificado | Estado de revisão BBOX | Ausência de vulnerabilidades |
