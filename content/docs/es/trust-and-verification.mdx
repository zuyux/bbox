...
description: Conoce lo que indican las señales de confianza de BBOX, sus límites y cómo evaluar software con seguridad.
---

BBOX reúne evidencia para facilitar la evaluación del software. No pretende sustituir el criterio del usuario por una insignia, puntuación o transacción blockchain.
...
| Insignia verificada | Estado de revisión en BBOX | Ausencia de vulnerabilidades |
