...
Enable [Developer Mode](/settings#developer-mode), prepare the listing, and review every external link before submitting. Publishing a record makes claims easier to inspect; it does not cause BBOX or Bitcoin to endorse those claims.
